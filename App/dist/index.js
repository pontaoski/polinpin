(() => {
  ...
  var applyFirst = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply12(map32($$const)(a2))(b2);
      };
    };
  };
  var applySecond = function(dictApply) {
    ...
    return function(a2) {
      return function(b2) {
        return apply12(map32($$const(identity2))(a2))(b2);
      };
    };
  };
            ...
            switch (head4.tag) {
              ...
              case APPLY:
                ...
                if (fail) {
                  ...
                  tmp = true;
                  kid = killId++;
                  kills[kid] = kill3(early, fail === lhs ? head4._2 : head4._1, function() {
                    return function() {
                      delete kills[kid];
                      if (tmp) {
                        tmp = false;
              ...
              case ALT:
                ...
                if (lhs !== EMPTY && util.isLeft(lhs) && rhs !== EMPTY && util.isLeft(rhs)) {
                  ...
                  tmp = true;
                  kid = killId++;
                  kills[kid] = kill3(early, step3 === lhs ? head4._2 : head4._1, function() {
                    return function() {
                      delete kills[kid];
                      if (tmp) {
                        tmp = false;
  ...
  var bitraversableTuple = {
    bitraverse: function(dictApplicative) {
      ...
      return function(f) {
        return function(g) {
          return function(v) {
            return apply3(map32(Tuple.create)(f(v.value0)))(g(v.value1));
          };
        };
      };
    },
    bisequence: function(dictApplicative) {
      ...
      var map32 = map(Apply0.Functor0());
      return function(v) {
        return apply3(map32(Tuple.create)(v.value0))(v.value1);
      };
    },
    Bifunctor0: function() {
  ...
  var applyRouteDuplex = {
    apply: function(v) {
      return function(v1) {
        return new RouteDuplex(apply1(map111(append8)(v.value0))(v1.value0), apply2(v.value1)(v1.value1));
      };
    },
    Functor0: function() {
      ...
      return {
        gRouteDuplex: function(end$prime) {
          return function(r) {
            ...
            var dec = alt5(map29(Inl.create)(v.value1))(map29(Inr.create)(v1.value1));
  ...
  // output/Polinpin.Interfaces/index.js
  ...
  var navigationHalogenM = function(dictNavigation) {
    return {
      navigate: function() {
        var $34 = lift5(dictNavigation.Monad0());
        var $35 = navigate(dictNavigation);
        return function($36) {
          return $34($35($36));
        };
      }(),
  ...
  var genericRoute = {
    to: function(x) {
      ...
      ;
      throw new Error("Failed pattern match at Polinpin.Interfaces (line 16, column 1 - line 16, column 48): " + [x.constructor.name]);
    },
    from: function(x) {
  ...
  var routeCodec = /* @__PURE__ */ root(/* @__PURE__ */ sum2(genericRoute)(/* @__PURE__ */ gRouteSum(/* @__PURE__ */ gRouteConstructor({
    ...
    Home: noArgs,
    Login: /* @__PURE__ */ gsep(/* @__PURE__ */ gsepStringRoute(gRouteNoArguments))("login")(noArgs)
  }));
  var eqRoute = {
    eq: function(x) {
      return function(y) {
  ...
  // output/Polinpin.Store/index.js
  ...
  var setHash2 = function(h) {
    return bind6(bind6(windowImpl)(location))(setHash(h));
  };
  var getHash = /* @__PURE__ */ bind6(/* @__PURE__ */ bind6(windowImpl)(location))(/* @__PURE__ */ function() {
    var $16 = map30(function() {
      var $18 = fromMaybe("");
      var $19 = stripPrefix("#");
      return function($20) {
        return $18($19($20));
  ...
  var monadAffAppMM = /* @__PURE__ */ monadAffStoreT(monadAffAff);

  // output/Polinpin.Router/index.js
  ...
  var component = function(dictMonadAff) {
    ...
    return function(dictNavigation) {
      var navigate2 = navigate(navigationHalogenM(dictNavigation));
      return function(dictMonadStore) {
        ...
        var handleAction = function(v) {
          if (v instanceof Initialize2) {
            return bind7(map31(function() {
              var $38 = parse7(routeCodec);
              return function($39) {
                return hush($38($39));
              };
            }())(liftEffect8(getHash)))(function(initialRoute) {
          ...
          ;
          throw new Error("Failed pattern match at Polinpin.Router (line 52, column 20 - line 57, column 22): " + [v.constructor.name]);
        };
        return mkComponent({
  ...
  var component2 = /* @__PURE__ */ component(monadAffAppMM)(navigationAppM)(monadStoreAppM);
  var pure11 = /* @__PURE__ */ pure(applicativeAff);
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind8(awaitBody)(function(body2) {
    return bind8(runAppM({})(component2))(function(rootComponent) {
      return bind8(runUI2(rootComponent)(unit)(body2))(function(halogenIO) {
        return pure11(unit);
      });
    });
  }));
