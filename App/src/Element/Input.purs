...
import Element (Attribute, Color, Element)
...
darkGrey =
    Element.rgb (186.0 / 255.0) (189.0 / 255.0) (182.0 / 255.0)
...
{-| -}
-- data Label r p i
--     = Label LabelLocation (List (Attribute r p i)) (Element p i)
--     | HiddenLabel String
...
focusDefault attrs =
    if Array.any hasFocusStyle attrs then
        Internal.NoAttribute
...
{-| -}
-- onKeyLookup :: forall r p i. (String -> Maybe i) -> Attribute r p i
-- onKeyLookup lookup =
--     let
--         decode code =
--             case lookup code of
