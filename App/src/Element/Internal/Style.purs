...
classes =
    ...
    -- widhts/heights
    , widthFill: ClassName "widthFill"
    , widthContent: ClassName "widthContent"
    , widthExact: ClassName "widthExact"
    , widthFillPortion: ClassName "widthFillPortion"
    , heightFill: ClassName "heightFill"
    , heightContent: ClassName "heightContent"
    , heightExact: ClassName "heightExact"
    , heightFillPortion: ClassName "heightFillPortion"
    , seButton: ClassName "seButton"

    -- nearby elements
    , nearby: ClassName "nearby"
    , above: ClassName "above"
    , below: ClassName "below"
    , onRight: ClassName "onRight"
    , onLeft: ClassName "onLeft"
    , inFront: ClassName "inFront"
    , behind: ClassName "behind"
    , hasBehind: ClassName "hasBehind"

    -- alignments
    , alignTop: ClassName "alignTop"
    , alignBottom: ClassName "alignBottom"
    , alignRight: ClassName "alignRight"
    , alignLeft: ClassName "alignLeft"
    , alignCenterX: ClassName "alignCenterX"
    , alignCenterY: ClassName "alignCenterY"
    , alignedHorizontally: ClassName "alignedHorizontally"
    , alignedVertically: ClassName "alignedVertically"

    -- space evenly
    , spaceEvenly: ClassName "spaceEvenly"
    , container: ClassName "container"
    , alignContainerRight: ClassName "alignContainerRight"
    , alignContainerBottom: ClassName "alignContainerBottom"
    , alignContainerCenterX: ClassName "alignContainerCenterX"
    , alignContainerCenterY: ClassName "alignContainerCenterY"
    ...
    , contentCenterX: ClassName "contentCenterX"
    , contentCenterY: ClassName "contentCenterY"

    -- selection
    , noTextSelection: ClassName "noTextSelection"
    , cursorPointer: ClassName "cursorPointer"
    , cursorText: ClassName "cursorText"

    -- pointer events
    , passPointerEvents: ClassName "passPointerEvents"
    , capturePointerEvents: ClassName "capturePointerEvents"
    , transparent: ClassName "transparent"
    , opaque: ClassName "opaque"
    , overflowHidden: ClassName "overflowHidden"
    ...
    , focusedWithin: ClassName "focus-focusedWithin"
    ...
    , scrollbarsX: ClassName "scrollbarsX"
    , scrollbarsY: ClassName "scrollbarsY"
    , clip: ClassName "clip"
    , clipX: ClassName "clipX"
    , clipY: ClassName "clipY"

    -- borders
    , borderNone: ClassName "borderNone"
    , borderDashed: ClassName "borderDashed"
    , borderDotted: ClassName "borderDotted"
    , borderSolid: ClassName "borderSolid"

    -- text weight
    , sizeByCapital: ClassName "sizeByCapital"
    , fullSize: ClassName "fullSize"
    , textThin: ClassName "textThin"
    , textExtraLight: ClassName "textExtraLight"
    , textLight: ClassName "textLight"
    , textNormalWeight: ClassName "textNormalWeight"
    , textMedium: ClassName "textMedium"
    , textSemiBold: ClassName "textSemiBold"
    , bold: ClassName "bold"
    , textExtraBold: ClassName "textExtraBold"
    , textHeavy: ClassName "textHeavy"
    , italic: ClassName "italic"
    , strike: ClassName "strike"
    , underline: ClassName "underline"
    , textUnitalicized: ClassName "textUnitalicized"

    -- text alignment
    , textJustify: ClassName "textJustify"
    , textJustifyAll: ClassName "textJustifyAll"
    , textCenter: ClassName "textCenter"
    , textRight: ClassName "textRight"
    , textLeft: ClassName "textLeft"
    , transition: ClassName "transition"

    -- inputText
    , inputText: ClassName "inputText"
    , inputMultiline: ClassName "inputMultiline"
    , inputMultilineParent: ClassName "inputMultilineParent"
    , inputMultilineFiller: ClassName "inputMultilineFiller"
    , inputMultilineWrapper: ClassName "inputMultilineWrapper"
