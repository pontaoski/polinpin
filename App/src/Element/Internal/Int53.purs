...
module Element.Internal.Int53
    ...
    , even, odd
    , pow, abs
    , and, or, xor, shl, shr, zshr, complement
    ) where
...
fromString str = bind (Number.fromString str) fromNumber
...
-- | Bitwise AND.
foreign import and :: Int53 -> Int53 -> Int53

-- | Bitwise OR.
foreign import or :: Int53 -> Int53 -> Int53

-- | Bitwise XOR.
foreign import xor :: Int53 -> Int53 -> Int53

-- | Bitwise shift left.
foreign import shl :: Int53 -> Int53 -> Int53

-- | Bitwise shift right.
foreign import shr :: Int53 -> Int53 -> Int53

-- | Bitwise zero-fill shift right.
foreign import zshr :: Int53 -> Int53 -> Int53

-- | Bitwise NOT.
foreign import complement :: Int53 -> Int53
